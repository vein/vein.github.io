...
$axure.internal(function($ax) {
    ...
    var _escapeRichText = function(text) {
        ...
        return text.replace('<', '&lt;');="" };="" });="" *****="" utils.temp.js="" *******="" deep="" copy="" ********="" $axure.internal(function($ax)="" {="" todo:="" [ben]="" ah,="" infinite="" loops="" cause="" major="" issues="" here.="" tried="" saving="" objects="" we've="" already="" hit,="" but="" that="" didn't="" seem="" to="" work="" (at="" least="" at="" my="" first="" shot).="" var="" _deepcopy="function(original," trackcopies)="" if(trackcopies)="" index="_getCopyIndex(original);" if(index="" !="-1)" return="" _originaltocopy[index][1];="" }="" isarray="original" instanceof="" array;="" isobject="!(original" function)="" &&="" !(original="" date)="" (original="" object);="" if(!isarray="" !isobject)="" original;="" ?="" []="" :="" _originaltocopy.push([original,="" copy]);="" deepcopyarray(original,="" trackcopies,="" copy)="" deepcopyobject(original,="" copy);="" copy;="" $ax.deepcopy="_deepCopy;" hacky="" way="" event="" info.="" copying="" draginfo="" causes="" due="" hashmap="" doesn't="" map="" well.="" it="" just="" tostrings="" them,="" making="" them="" all="" the="" same="" key.="" this="" has="" be="" slow...="" _originaltocopy="[];" _getcopyindex="function(original)" for(var="" i="0;" <="" _originaltocopy.length;="" i++)="" if(original="==" _originaltocopy[i][0])="" i;="" -1;="" $ax.eventcopy="function(eventInfo)" delete="" eventinfo.draginfo;="" true);="" copy.draginfo="dragInfo;" eventinfo.draginfo="dragInfo;" reset="" map.="" deepcopyarray="function(original," original.length;="" copy[i]="_deepCopy(original[i]," trackcopies);="" deepcopyobject="function(original," key="" in="" original)="" if(!original.hasownproperty(key))="" continue;="" copy[key]="_deepCopy(original[key]," our="" implementation="" of="" splice="" because="" is="" broken="" ie8...="" $ax.splice="function(array," startindex,="" count)="" retval="[];" if(startindex="">= array.length || startIndex < 0 || count == 0) return retval;
